	...
	p._initFlotVisitors = function () {
		...
		var data = [
			...
			},*/
			{
				label: '2016',
				data: [
					[moment().subtract(8920, 'hours').valueOf(), 20],
					[moment().subtract(7200, 'hours').valueOf(), 2500],
					[moment().subtract(6480, 'hours').valueOf(), 2700],
					[moment().subtract(5760, 'hours').valueOf(), 2000],
					[moment().subtract(5050, 'hours').valueOf(), 3000],
					[moment().subtract(4320, 'hours').valueOf(), 3500],
					[moment().subtract(3600, 'hours').valueOf(), 3000],
					[moment().subtract(2900, 'hours').valueOf(), 4000],
					[moment().subtract(2200, 'hours').valueOf(), 4700],
					[moment().subtract(1460, 'hours').valueOf(), 5000],
					[moment().subtract(720, 'hours').valueOf(), 500],
					[moment().valueOf(), 20]
				],
				last: true
			}
		...
		var options = {
			...
			grid: {
				borderWidth: 0,
				/*color: labelColor,*/
				color: '#ff0000',  //graph line
				hoverable: true,
				show: true			//line visibility show/hide
			}
		};
		chart.width('100%');
