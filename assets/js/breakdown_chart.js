		...
		var data = [
			...
			},*/
			{
				...
				data: [
					...
					[moment().subtract(6480, 'hours').valueOf(), 2000],
					[moment().subtract(5760, 'hours').valueOf(), 1500],
					[moment().subtract(5050, 'hours').valueOf(), 3000],
					[moment().subtract(4320, 'hours').valueOf(), 4500],
					[moment().subtract(3600, 'hours').valueOf(), 3000],
					[moment().subtract(2900, 'hours').valueOf(), 4000],
					[moment().subtract(2200, 'hours').valueOf(), 4700],
					[moment().subtract(1460, 'hours').valueOf(), 5700],
