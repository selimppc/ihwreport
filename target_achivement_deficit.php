...
<head>
    ...
    <script src="assets/js/target_deficit.js"></script>
        ...
        <section>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <!--===== For Target Achievement Deficit (Taka and Qty)==============================================================-->
                    <div class="card">
                        <div class="row" id="site-activity">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6" style="position: relative; padding:0 5%; ">
                                    <div id="chart_target_achievement_deficit_taka" style="width: 100%; height: 400px;"></div>
                                </div>

                                <div class="col-md-6" style="position: relative; padding:0 5%; ">
                                    <div id="chart_target_achievement_deficit_qty" style="width: 100%; height: 400px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row" id="site-activity">
                            <div class="col-md-12">
                                <div class="col-md-9">
                                    ...
                                    <div id="chart_delivery_goods" style="width: 100%; height: 500px;"></div>
                                </div>
